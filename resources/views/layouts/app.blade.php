...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="#" class="logo">
            ...
            <span class="logo-mini"><b>D</b>RH</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>{{ auth()->user()->general->name }}</b></span>
        </a>
        ...
        <section class="sidebar text-white">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('dossiers.coter-admin') }}"><i class="fa fa-circle-o"></i> Dossiers
                                Cotés</a></li>
                        <li><a href="{{ route('dossiers.noncoter_admin') }}"><i class="fa fa-circle-o"></i> Dossiers
                                Non Cotés</a></li>
                        <li><a href="{{ route('dossiers.traiter-admin') }}"><i class="fa fa-circle-o"></i> Dossiers
                                Traités</a></li>
                    </ul>
                </li>
                <li>
