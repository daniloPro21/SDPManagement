        ...
        <div class="container">
            <div class="row">
                <section class="invoice">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <a onclick="return confirm('voulez vous vraiment effectuer cette action ?')" href="{{ route("fichenominations.delete",$fiche->id) }}" class="btn btn-danger pull-right">Supprimer</a>
...
") !!}
                    ...
                    <div class="row" id="no-print">
                        <div class="col-xs-12">
                            <a href="{{ route('nomination.print',$fiche->id) }}"  class="btn btn-success"><i class="fa fa-print"></i> Imprimer</a>
                            @if($fiche->etat == "ouvert")
                                ...
                                @else
                                <a href="{{ route("nomination.unlock",$fiche->id) }}" onclick="return confirm('Souhaitez-vous vraiment Ré-ouvrir ce dossier ?');" class="btn btn-primary pull-right mr-3"
                                   style="margin-right: 3% !important;"
    ...
    <div class="modal fade" id="affectationModal" tabindex="-1" aria-labelledby="AffectationModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('nomination.new',$fiche->id) }}">
