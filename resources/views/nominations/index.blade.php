        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-offset-10 col-sm-2">
                    <a href="#" data-toggle="modal" data-target="#affectationModal" class="d-flex btn btn-primary btn-sm mb-1">Nouvel Ordre de Nomination</a>
                </div>
            </div>
        @forelse($affectations as $affectation)
            <!-- /.col -->
                <a href="{{route('nomination.manage',$affectation->id)}}" style="text-decoration:none;color:black" class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <select name="type" class="form-control" id="type">
                                <option value="Nomination Chef de Bureau PSF et CVI">Nomination Chef de Bureau PSF et CVI</option>
                                <option value="Nomination  SG et ECO">Nomination  SG et ECO</option>
                                <option value="Projet Nomination CDS et Dir HD">Projet Nomination CDS et Dir HD</option>
                            </select>
                        </div>
                    </div>
                        <div class="form-row">
